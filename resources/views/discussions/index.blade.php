...
@section('content')
    ...
    <div class="grid lg:grid-cols-12 gap-6 px-2 lg:px-0">
        ...
        <div class="lg:col-span-3 lg:max-h-3/5 bg-gray-800 rounded-md shadow-md p-6 lg:mt-[3.7rem]">
        ...
        <div class="lg:col-span-9">
            <div class="flex justify-between">
                <h2 class="text-2xl font-semibold text-cyan-700">Discussionboard</h2>
            ...
            @foreach ($discussions as $discussion)
                <div class="bg-white rounded-md shadow-md overflow-hidden my-5">
                    ...
                    <div class="flex items-center justify-end px-6 my-6">
